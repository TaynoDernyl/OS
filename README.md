...
Продвигать системное программирование в массы для простых людей планируется издать книгу чтобы каждый смог увидеть как проект развивался "за кулисами", какие были идеи, что воплотил, а что нет и по каким причинам.
...
## 📖 Компилятор на C (разработка идет, ниже приведены концепты):
...
## Документация
Для более глубокого анализа проекта:
[=====ДОКУМЕНТАЦИЯ ПРОЦЕССОРА=====](docs/cpu.md)
...
- Python 3.11+ (Для компилятора на Python)
...
4. Учебные проекты на SSwager есть в папке ["programs on LETOS"](/programs%20on%20LETOS/)
...
Также в канале можно посмотреть хронологию развития проекта с начала и по сей день
